                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    <div class="mb-3 text-center">
                                        <img src="{{ asset('rock/images/logo-icon.png') }}" width="60"
                                            alt="" />
                                    </div>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('dashboard.doforgotPassword') }}" method="POST">
                                            @csrf
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary">Send Reset Password
                                                        Link</button>
                                                </div>
                                            </div>
                                        </form>
